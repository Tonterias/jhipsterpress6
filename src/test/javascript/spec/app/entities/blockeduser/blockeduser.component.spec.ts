...
import { JhipsterPress06TestModule } from '../../../test.module';
import { BlockeduserComponent } from 'app/entities/blockeduser/blockeduser.component';
    ...
    describe('Blockeduser Management Component', () => {
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                imports: [JhipsterPress06TestModule],
