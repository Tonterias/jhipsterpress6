...
public class BlockeduserDTO implements Serializable {
    ...
    public void setBlockinguserId(Long communityId) {
        this.blockinguserId = communityId;
    }
    ...
    public void setBlockeduserId(Long communityId) {
        this.blockeduserId = communityId;
    }
