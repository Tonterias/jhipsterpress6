...
public class Community implements Serializable {
    ...
    public Community blockingusers(Set<Blockeduser> blockedusers) {
        this.blockingusers = blockedusers;
        return this;
    }

    public Community addBlockinguser(Blockeduser blockeduser) {
        this.blockingusers.add(blockeduser);
        blockeduser.setBlockinguser(this);
        return this;
    }

    public Community removeBlockinguser(Blockeduser blockeduser) {
    ...
    public Community blockedusers(Set<Blockeduser> blockedusers) {
        this.blockedusers = blockedusers;
        return this;
    }

    public Community addBlockeduser(Blockeduser blockeduser) {
        this.blockedusers.add(blockeduser);
        blockeduser.setBlockeduser(this);
        return this;
    }

    public Community removeBlockeduser(Blockeduser blockeduser) {
